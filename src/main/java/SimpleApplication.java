...
import controllers.ToggleTagController;
...
public class SimpleApplication extends Application<Configuration> {
    ...
    public static org.jooq.Configuration setupJooq() {
        ...
        final String jdbcUrl = "jdbc:h2:mem:receiptsapp;MODE=MySQL;INIT=RUNSCRIPT from 'classpath:schema.sql'";
    ...
    public void run(Configuration cfg, Environment env) {
        ...
        env.jersey().register(new ToggleTagController(receiptDao, tagDao));
    }
}
